...
- ROBA4: El siguiente jugador roba 4 cartas (con cambio de color asignado) y pierde su turno.
...
5. Abre todos los archivos .java de ambas carpetas en sus programas ejecutables, el resto te lo dejo de tarea, ejecutalos... y ¡ENJOY IT!