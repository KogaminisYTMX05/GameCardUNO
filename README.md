...
## Mejoras en la actualización 5.0 (20/05/2026)

- Cambios necesarios al código ya que en su versión temprana NO publicada aquí, hubo muchos problemas en respetar las reglas de turno, saltos injustos, crasheo de turnos altamente masivos, el sentido antihorario no llegó a funcionarse y algunas cartas especiales NO cumplían con su función (crasheos reportados).
- Implementación de una nueva clase "GUI.java" (Interfaz) de donde puedes interactuar con el mouse.
- Se añadió latencia de 2 segundos a las CPU para ver que cartas tiraron.
- Contador de tiempo de 5 segundos al jugador humano para decir UNO al tener una sola carta (sanción: +2 cartas al expirar el tiempo).

## Capturas de comparación:

-v4 (Solamente texto):
![image alt](https://github.com/KogaminisYTMX05/GameCardUNO/blob/31e1de04263cb9868206177ca9e69ed13f6bd410/screenshots/v4.png)

-v5 (Interfaz con sprites de cartas, 3 botones y un chat de acontecimientos):
![image alt](https://github.com/KogaminisYTMX05/GameCardUNO/blob/31e1de04263cb9868206177ca9e69ed13f6bd410/screenshots/v5.png)

## Diagrama UML (Versión 5.0):
![image alt](https://github.com/KogaminisYTMX05/GameCardUNO/blob/31e1de04263cb9868206177ca9e69ed13f6bd410/assets/uml_complete_v5.0.png)

## Mejoras en la actualización 4.1 (30/04/2026)

- En las carpetas "src" y "test" tienen carpetas separadas para su funcionamiento (para A pache NetBeans IDE y Eclipse IDE).
- El código es el mismo ejecutable en esos programas mencionados, pero tienen diferencias entre java array.list... y package...
- Se incluyó la carpeta javadoc en la carpeta dist para su visualización de todas las clases redactadas "package-summary.html" (añadido en la versión pasada).

El diagrama UML es la misma de la versión pasada.
...
5. Abre todos los archivos .java de la carpeta "src/uno", ejecutalos y ¡ENJOY IT!